...
function ClubList() {
  ...
  // ! create a new club function
  const createClubHandler = async () => {
    console.log("Create club called");
  ...
  const fetchAllEventOfClub = async () => {
    ...
    try {
      console.log("fetching all events of club called");
  ...
  useEffect(() => {
    ...
    console.log(selectedClub?.events);
  ...
  return (
    ...
    >
      ...
      {/* create club or event form model */}
